const employees = [
    ...
    { name: "Никита", greeting: "Поздравляю с твоим днем! Побольше душевного спокойствия, приятных денежных оповещений, только побед, громких успехов, чтобы каждый день был наполнен радостью и милотой! И по традиции щастья-здоровья!", character: 2 },
